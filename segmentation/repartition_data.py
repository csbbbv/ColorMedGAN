...
def partition_data(dataset_dir, ouput_root):
    ...
    for file in os.listdir(os.path.join(dataset_dir, "norm")):
        image_names.append(file)
        image_names.sort()
    for file in os.listdir(os.path.join(dataset_dir, "label4_onehot")):
...
if __name__ == '__main__':
    dataset_dir = '/media/user/8f28289d-aa45-46ab-b9e4-a7d4d9f08b7e/shaobo/oasis1/'
    output_root = '/media/user/8f28289d-aa45-46ab-b9e4-a7d4d9f08b7e/shaobo/oasis1/'
